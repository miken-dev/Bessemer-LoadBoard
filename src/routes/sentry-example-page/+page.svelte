	...
	<main>
		...
		<p class="description">
			Click the button below, and view the sample error on the Sentry <a
				target="_blank"
				href="https://dennison-creative.sentry.io/issues/?project=4509437733240832">Issues Page</a
		...
		{:else if !isConnected}
			<div class="connectivity-error">
				<p>
					The Sentry SDK is not able to reach Sentry right now - this may be due to an adblocker.
